@capec259
Feature: CAPEC-259: Passively Sniffing and Capturing Application Code Bound for an Authorized Client During Patching
#2. Exploit
Scenario: Step2.1 Capturing Application Code Bound During Patching
