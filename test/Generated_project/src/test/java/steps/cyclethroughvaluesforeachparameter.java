...
public class cyclethroughvaluesforeachparameter {
@Given("prepare to Cycle through values for each parameter.")
public void precyclethroughvaluesforeachparameter(){
...
@When("Try to Cycle through values for each parameter.")
public void trycyclethroughvaluesforeachparameter(){
//  Try one of the following techniques :
   //1.  Use network-level packet injection tools such as netcat
   //2.  Use application-level data modification tools such as Tamper Data, WebScarab, TamperIE, etc.
   //3.  Use modified client (modified by reverse engineering)
   //4.  Use debugging tools to modify data in client
}@Then("Assert the success of Cycle through values for each parameter.")
public void asscyclethroughvaluesforeachparameter(){
